...
9. **Автосохранение состояния** — все изменения сохраняются в `repo_manager_config.json`
...
Приложение автоматически сохраняет состояние в файл `repo_manager_config.json` в корневой папке проекта. Этот файл содержит:
